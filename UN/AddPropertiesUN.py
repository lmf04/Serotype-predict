...
hmtp210 = pd.read_csv('D:/Python/UNhmtp210.csv',header=None)
#下面这个用来做多维数组
numhmtp210 = hmtp210.to_numpy()

aaindex = pd.read_csv("D:/Python/ML/sourceData/aaindex1.csv",header=None)
#制作字典
...
#遍历序列并制作替换表
HydroList = np.zeros((346, 267))
x=0
for seq in hmtp210.iloc[0:,1]:
    seq=list(seq)
    y=0
    for aa in seq:
...
# while n<55:
#     PolaList[n]
#     numhmtp210[m, 5]=PolaList[n]
#     n=n+1
#     m=m+1


numhmtp210= np.concatenate((numhmtp210,HydroList),axis=1)

np.save('D:/Python/ML/UN/UNhmtp210.npy', numhmtp210)