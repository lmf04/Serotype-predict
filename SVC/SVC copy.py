...
# numhmtp210=np.load('D:/Python/ML/UN/hmtp210.npy',allow_pickle=True)
# numhmtp210=pd.DataFrame(numhmtp210)
# numhmtp210.to_csv("D:/Python/trainHmtp.csv",header=None,index=False)
...
dump(modelSVM, 'D:/Python/ML/SVC/SVMmodelV2.joblib')
...
plt.ylabel('True')
plt.title('Confusion Matrix for SVM on HMTp210 Dataset')
plt.show()
...
plt.savefig('D:/Python/result/SVCPermutationImportanceH2.png')
plt.show()
